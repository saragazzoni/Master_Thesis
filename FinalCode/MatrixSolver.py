...
class MatrixSolver(ABC):
    ...
    def __init__(self, mesh, V, n0, c_0, dt, T, save_interval, times, doses, path_sol, f,dz):
        self.mesh = mesh
        self.V = V
        self.n0 = n0
        self.c_k = c_0
...
class MatrixSolver2D(MatrixSolver):
    ...
    def __init__(self, mesh, V, n0, c_0, dt, T, save_interval, times, doses, path_sol, f,dz):
        super().__init__(mesh, V, n0, c_0, dt, T, save_interval, times, doses, path_sol, f,dz)
    ...
    def oxygen_bc(self,bc_type):
        if bc_type == 'homogeneous':
            bc = DirichletBC(self.V, Constant(0), self.ds, 0)
        elif bc_type == 'nonhomogeneous':
